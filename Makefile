# entity-kit Makefile
# Headless React component library - BeanInfo pattern for TypeScript/React

.PHONY: help install build test test-watch lint lint-fix clean \
        pack inspect publish publish-dry version-patch version-minor version-major \
        link unlink release pre-release check-all
...
inspect: pack ## Show what would be published
	...
	@tar -tf astrapi69-entity-kit-*.tgz
	@echo ""
	@echo "Package size:"
	@ls -lh astrapi69-entity-kit-*.tgz
	@rm -f astrapi69-entity-kit-*.tgz
...
link: build ## Link package locally (for Bibliogon/Phylax dev)
	npm link
	@echo ""
	@echo "Linked. In consuming app run:"
	@echo "  npm link @astrapi69/entity-kit"

unlink: ## Unlink local package
	npm unlink
	@echo ""
	@echo "Unlinked. In consuming app run:"
	@echo "  npm unlink @astrapi69/entity-kit"
	@echo "  npm install"
